...
// Menampilkan semua data dari table game berdasarkan nim secara Descending
$siswa = query("SELECT * FROM game ORDER BY tanggal DESC");
?>
<!DOCTYPE html>
<html lang="en">
...
<span id="menuIcon" class="menu-icon" onclick="toggleSidebar()">&#9776; GAME PORTAL <img src="img/bg/logo12.png" alt="Game Portal" class="game-portal-logo"></span>
    ...
    <div class="row my-2 justify-content-end"> 
        <div class="col-md-auto"> 
            <a href="addData_game.php" class="btn btn-primary"><i class="bi bi-person-plus-fill"></i>&nbsp;Tambah Data</a>
                ...
                <tbody>
                    ...
                    <?php foreach ($siswa as $row) : ?>
                        <tr>
                            ...
                            <td><?= $row['ulasan']; ?></td>
                            <td>
                                <a href="ubahgame.php?nama_game=<?= $row['nama_game']; ?>" class="btn btn-warning btn-sm" style="font-weight: 600;"><i class="bi bi-pencil-square"></i>&nbsp;Ubah</a> |
                                <a href="hapusgame.php?nama_game=<?= $row['nama_game']; ?>" class="btn btn-danger btn-sm" style="font-weight: 600;" onclick="return confirm('Apakah anda yakin ingin menghapus data <?= $row['nama_game']; ?> ?');"><i class="bi bi-trash-fill"></i>&nbsp;Hapus</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
